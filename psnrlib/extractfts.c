...
#endif
{
	...
	if (szInfo.repeat > 0)
	{
		...
		{
		case GOTMB:
			sprintf(sname, "debugmb_%03d.bmp", framenum);
			break;
		case GOTQP:
			sprintf(sname, "debugqp_%03d.bmp", framenum);
			break;
		case GOTMV:
			sprintf(sname, "debugmv_%03d.bmp", framenum);
			break;
		case GOTRD:
			sprintf(sname, "debugrd_%03d.bmp", framenum);
			break;
		case GOTMB ^ GOTQP:
			sprintf(sname, "debugmbqp_%03d.bmp", framenum);
			break;
		case GOTMV ^ GOTRD:
			sprintf(sname, "debugmvrd_%03d.bmp", framenum);
			break;
		default:
			break;
		}
